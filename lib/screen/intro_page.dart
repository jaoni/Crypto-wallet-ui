          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                FadeInLeft(child: Text('Create Your Cryptocurrency Wallet App', 
                style: TextStyle(color:Colors.yellowAccent[700], fontSize: 42, fontWeight: FontWeight.bold, fontFamily: ''),)),
                const SizedBox(height: 20,),
                FadeInLeft(child: const Text('Grow your portfolio by receiving rewards up to 15.5% on your crypto assets', 
